...
#include "../headers/Shoot.hpp"

namespace asteroid {


    Player::Player(World &world)
            : Entity(asteroid::Configuration::Textures::Player, world),
              ActionTarget(asteroid::Configuration::playerInputs),
              _isMoving(false),
              _rotation(0) {
    ...
    void Player::goToHyperspace() {
        ...
        setPosition(asteroid::random(0, _world.getX()), asteroid::random(0, _world.getY()));
